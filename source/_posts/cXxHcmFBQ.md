...
isTop: false
---
![img](https://gitee.com/limeng1984/pstore/raw/master/blog/7976ad0cf5a2495e8b4f9c1488cad5a6~tplv-k3u1fbpfcp-zoom-1-20210108161535288.png)
...
![尤雨溪微博](https://gitee.com/limeng1984/pstore/raw/master/blog/9ce8dc2393a14d05b2de95cd31f63f65~tplv-k3u1fbpfcp-zoom-1-20210108161602931.png)
...
![JavaScript modules](https://gitee.com/limeng1984/pstore/raw/master/blog/4ea74bfd40eb4bd19ac5c2553c20d99b~tplv-k3u1fbpfcp-zoom-1-20210108161615764.png)

## 上手 vite

vite 带着它的历史使命随之出现。由于省略了打包的过程，首次启动 vite 的时候可谓秒开。可以看下我录制的 Gif 图，完全无需等待就能进入开发。

![启动 vite](https://gitee.com/limeng1984/pstore/raw/master/blog/e5c2f1b447a94d78a6dd7feede85c6aa~tplv-k3u1fbpfcp-zoom-1-20210108161628429.png)
...
![其他模板](https://gitee.com/limeng1984/pstore/raw/master/blog/4624aa2dce3c428c8d432e0499b5cf76~tplv-k3u1fbpfcp-zoom-1.png)

生成的 vue 项目的目录结构如下。

![目录结构](https://gitee.com/limeng1984/pstore/raw/master/blog/a24d2b63fe434bf3a4a14ed1f285d66a~tplv-k3u1fbpfcp-zoom-1-20210108161704386.png)

项目的入口为 `index.html`，html 文件中直接使用了浏览器原生的 ESM（`type="module"`） 能力。关于浏览器 ESM 能力的介绍，可以阅读我之前的文章[《前端模块化的今生》](https://blog.shenfq.com/2019/前端模块化的今生/)。
...
![请求](https://gitee.com/limeng1984/pstore/raw/master/blog/2c82d35d789a40d0b588718ff888b906~tplv-k3u1fbpfcp-zoom-1-20210108161720964.png)
...
![snowpack rename](https://gitee.com/limeng1984/pstore/raw/master/blog/e86b7ecd6ced4c878beaa2672e7be88a~tplv-k3u1fbpfcp-zoom-1-20210108161736686.png)

[pika](https://www.pika.dev/) 团队之所以要做 snowpack ，是因为 pika 致力于为 web 应用提速 90%。

![pika](https://gitee.com/limeng1984/pstore/raw/master/blog/9c269929d3274c7d8550eab428795685~tplv-k3u1fbpfcp-zoom-1-20210108161747677.png)
...
![snowpack](https://gitee.com/limeng1984/pstore/raw/master/blog/2027a2092435450d80723d0ae28fafb3~tplv-k3u1fbpfcp-zoom-1.png)

在 vite 的 README 中也提到了在某些方面参考了 snowpack，并且列举了 vite 与 snowpack 的异同。

![Different](https://gitee.com/limeng1984/pstore/raw/master/blog/e514691c06fd430e8174c6f4ca4e286f~tplv-k3u1fbpfcp-zoom-1.png)

snowpack 现在已经发布到 v2 了，我们可以找到 v1 时期的源码看看 snowpack 的早期实现。

### 源码解析

在 github 上，根据 git tag 可以找到 snowpack v1.0.0 的版本，下载下来发现好像有点 bug ，建议大家阅读源码的时候可以跳到 v1.2.0（[github.com/pikapkg/sno…](https://github.com/pikapkg/snowpack/tree/v1.2.0)）。
...
![目录结构](https://gitee.com/limeng1984/pstore/raw/master/blog/0a46563e2d2342ed938b23e81ab3994f~tplv-k3u1fbpfcp-zoom-1.png)
...
![npm run build](https://gitee.com/limeng1984/pstore/raw/master/blog/b23883ce79d44fc5a38251e7112f635e~tplv-k3u1fbpfcp-zoom-1.png)

![web_modules](https://gitee.com/limeng1984/pstore/raw/master/blog/c320c9d45d1649608426cae864854478~tplv-k3u1fbpfcp-zoom-1.png)
...
![install](https://gitee.com/limeng1984/pstore/raw/master/blog/e5c07acf714c4fb38806f6b0d0c3ac4c~tplv-k3u1fbpfcp-zoom-1.png)
...
![server](https://gitee.com/limeng1984/pstore/raw/master/blog/59ee8e217c2c400c826be145af47cb57~tplv-k3u1fbpfcp-zoom-1.png)
...
![main.js](https://gitee.com/limeng1984/pstore/raw/master/blog/daf232a60eec46e1935cfb52ba93ca96~tplv-k3u1fbpfcp-zoom-1.png)
...
template 中的内容，会被 vue 解析成 render 方法。关于 vue 模板是如何编译成 render 方法的，可以看我的另一篇文章：[《Vue 模板编译原理》](https://blog.shenfq.com/2020/vue-模板编译原理/)。
...
![模板](https://gitee.com/limeng1984/pstore/raw/master/blog/fce6d8eed2ac462c96c93411ef54f001~tplv-k3u1fbpfcp-zoom-1.png)
...
![vite翻译](https://gitee.com/limeng1984/pstore/raw/master/blog/be50ffd137e247cf853fb065ab190a00~tplv-k3u1fbpfcp-zoom-1-20210108162306704.png)

文章来源：[掘金](https://juejin.cn/post/6869915676501835783)

文章作者：[Shenfq](https://juejin.cn/user/2013961030742589)
